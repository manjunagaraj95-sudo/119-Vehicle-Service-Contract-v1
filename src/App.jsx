...
const SAMPLE_CONTRACTS = [
  ...
  },
  {
    ...
    slaDue: '2023-10-01',
    auditLog: [
      { id: 'AL008', timestamp: '2023-04-05T11:00:00Z', actor: 'Dealer Portal User', action: 'Contract Drafted', details: 'VSC for Ford F-150 created', type: 'user' },
      { id: 'AL009', timestamp: '2023-04-06T15:00:00Z', actor: 'System', action: 'E-signature Request Sent', details: 'Email sent to Charlie Brown for signature', type: 'system' },
    ],
    milestones: [
  ...
  },
  {
    ...
    slaDue: '2023-09-15',
    auditLog: [
      { id: 'AL010', timestamp: '2023-05-20T09:00:00Z', actor: 'Dealer Portal User', action: 'Contract Initiated', details: 'VSC for Mercedes-Benz C-Class', type: 'user' },
      { id: 'AL011', timestamp: '2023-05-22T16:00:00Z', actor: 'Underwriting Team', action: 'Contract Rejected', details: 'Vehicle age/mileage outside policy parameters', type: 'system' },
    ],
    milestones: [
  ...
  },
  {
    ...
    slaDue: '2023-12-01',
    auditLog: [
      { id: 'AL012', timestamp: '2023-07-15T10:00:00Z', actor: 'System Architect', action: 'Contract Initiated', details: 'New VSC for Tesla Model 3', type: 'user' },
      { id: 'AL013', timestamp: '2023-07-16T11:00:00Z', actor: 'System', action: 'Policy Rule Exception', details: 'New EV model triggered special legal review', type: 'system' },
    ],
    milestones: [
...
const ChartComponent = ({ type, title }) => (
  <div className="chart-container" style={{ margin: 'var(--spacing-md) 0' }}>
...
const MilestoneTracker = ({ milestones, currentStage }) => (
  <div className="milestone-tracker-card" style={{ marginBottom: 'var(--spacing-lg)' }}>
    ...
    {currentStage && (
      <p style={{ textAlign: 'center', fontSize: 'var(--font-size-sm)', color: 'var(--color-charcoal-700)' }}>
        ...
        <div className="detail-main-column">
          ...
          <div className="detail-summary-section">
            ...
            {contract.relatedDocuments?.length === 0 ? (
              <p style={{ color: 'var(--color-charcoal-500)', fontSize: 'var(--font-size-sm)' }}>No related documents.</p>
            ) : (
